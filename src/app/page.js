  ...
  web: [
    {
      ...
      link: "https://n59-3dars-8oy.netlify.app/",
      gitUrl: "https://github.com/AzizbekGayratov/Uy-ishi-3dars-8oy-",
    },
    {
      id: 2,
      name: "Project №2",
      image: "/2img.png",
      description: "This is project",
      link: "https://exam7-n59.netlify.app/",
      gitUrl: "https://github.com/AzizbekGayratov/exam7",
    },
    {
      id: 3,
      name: "Project №3",
      image: "/3img.png",
      description: "This is project",
      link: "https://newtodo-with-typescript.netlify.app/",
      gitUrl: "https://github.com/AzizbekGayratov/Uy-ishi-4dars-8oy-",
    },
  ],
  mobile: [
    {
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="container mt-24 mx-auto px-12 py-4">
        ...
        <section className="text-white" id="about">
          <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:p-16 xl:px-16">
            <Image src="/about.jpg" width={500} height={500} alt="img" />
        ...
        <section id="projects">
          ...
          <div className="text-white flex flex-row justify-center items-center gap-2 py-6">
            <button
              className={`${
                activePage === "All"
                  ? "text-white border-[#FD7256] rounded-full border-2 px-6 py-3 text-xl cursor-pointer"
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-row gap-4">
              <a href="https://github.com/AzizbekGayratov" target="_blank">
                <IoLogoGithub className="text-white text-[48px]" />
              </a>
              <a href="https://t.me/z1zbe" target="_blank">
          ...
          <div>
            <form className="flex flex-col">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-[#90DFAB] to-[#FD7256] hover:opacity-90 transition-opacity text-white font-medium py-2.5 px-5 rounded-lg w-full"
              >
                Send Message
              </button>
            </form>
      ...
      <footer className="footer border z-20 border-t-[#33353F] border-l-transparent border-r-transparent text-white">
